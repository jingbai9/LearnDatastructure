...
public class OrderServiceImpl implements OrderService {
    ...
    public Map<String, String> submitOrder(UserAndOrder userAndOrder) {
        ...
        if (order.getTotalCost() > user.getBalance()) {
            statusMap.put(Mall.STATUS, Mall.FAIL);
            statusMap.put(Mall.MSG, "可用余额不足");
         ...
         * 修改余额
         */
        userMapper.updateBalanceById(uid, new BigDecimal(user.getBalance() - order.getTotalCost()).setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue());
