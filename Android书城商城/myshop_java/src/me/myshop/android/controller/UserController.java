...
public class UserController {
    ...
    @ResponseBody
    public Double recharge(@RequestParam Integer uid, @RequestParam Double balance_change) {
        return userService.recharge(uid, balance_change);
    }

    @RequestMapping("/balance")
    @ResponseBody
    public Double balance(@RequestParam Integer uid) {
        return userService.balance(uid);
    }
