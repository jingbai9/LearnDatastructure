    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_modify_now.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 ...
                 */
                if (original_password.equals(MyData.getInstance(getApplicationContext()).getUser().getPassword())) {
                            ...
                            mHandler.post(new Runnable() {
                                ...
                                public void run() {
                                    if (result.getStatus().equals(Mall.SUCCESS)) {
                                        ...
                                        //设置当前用户的新密码
                                        MyData.getInstance(getApplicationContext()).getUser().setPassword(mNewPassword);
