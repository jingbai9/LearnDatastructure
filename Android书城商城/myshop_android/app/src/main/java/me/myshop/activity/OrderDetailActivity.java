        ...
        btn_pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.equals("") || phone.equals("") || address.equals("")) {
                    ...
                    intent.putExtra("rec_info",rec_info);
                    intent.putExtra("total_cost",mAllGoodsTotalCost);
                    intent.putExtra("goods_list",new ArrayList<>(mGoodsList));
                            ...
                            mHandler.post(new Runnable() {
                                ...
                                public void run() {
                                    if (result.getStatus().equals(Mall.SUCCESS)) {
                                        ...
                                        MyData.getInstance(getApplicationContext()).modifyOrder(mOrder.getId(), mRecInfo, mPayMode);
                                        finish();
            ...
            public void onClick(View view) {
                AlertDialog dialog = new AlertDialog.Builder(OrderDetailActivity.this)
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                final User user = MyData.getInstance(getApplicationContext()).getUser();
                                        ...
                                        mHandler.post(new Runnable() {
                                            ...
                                            public void run() {
                                                if (result.getStatus().equals(Mall.SUCCESS)) {
                                                    ...
                                                    MyData.getInstance(getApplicationContext()).deleteOrder(mOrder.getId());
