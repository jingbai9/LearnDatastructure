...
import me.myshop.R;
import me.myshop.activity.BalanceActivity;
...
import me.myshop.common.utils.ACache;
...
public class MyFragment extends Fragment {
    ...
    public static void modifyNickName() {
        if (mTVNickname != null) {
            mTVNickname.setText(MyData.getInstance(mTVNickname.getContext()).getUser().getNickname());
        }
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (MyData.getInstance(getActivity()).getUser() == null) {
            mTVNickname.setText("XXX");
        } else {
            mTVNickname.setText(MyData.getInstance(getActivity()).getUser().getNickname());
        }

        TableRow tr_balance = getActivity().findViewById(R.id.tr_balance);
        ...
        tr_balance.setOnClickListener(my_click_listener);
    ...
    private class MyClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.tr_balance:
                    Intent intent_balance = new Intent(getActivity(), BalanceActivity.class);
                    ...
                    AlertDialog dialog = new AlertDialog.Builder(getActivity())
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    final User user = MyData.getInstance(getActivity()).getUser();
                                    ACache.get(getActivity()).remove("login_user");
